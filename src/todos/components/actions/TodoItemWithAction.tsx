...
interface TodoItemWithActionProps {
  todo: Todo;
  toggleTodo: (id: string, complete: boolean) => Promise<Todo | void>;
}

export const TodoItemWithAction = ({ todo, toggleTodo }: TodoItemWithActionProps) => {

  const [todoOptimistic, toggleTodoOptimistic] = useOptimistic(todo,
    (state, newCompletyeValue: boolean) => ({
      ...state, complete: newCompletyeValue
    }));
